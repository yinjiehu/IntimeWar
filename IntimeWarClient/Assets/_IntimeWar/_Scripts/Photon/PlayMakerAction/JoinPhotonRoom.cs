...
namespace MechSquad.RealTime
{
    ...
    public class JoinPhotonRoom : FsmStateAction
    {
		...
		public override void OnEnter()
        {
			...
			_actualRoomID = AddClientVersionToRoomID ? 
				View.RoomCreate.RoomCreatePresenter.SeletedRoom + "_" + Application.version : View.RoomCreate.RoomCreatePresenter.SeletedRoom;
